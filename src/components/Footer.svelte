...
>
  <Button text="Edit" icon={mdiNoteEditOutline}  on:click={() => ($editMode = true)}/>
  <Button text="Copy Link" icon={mdiContentCopy} />
  <Button text="GitHub" icon={mdiGithub} />
</div>

<style>
  .shadow {
    box-shadow: 0 -2px 12px -3px rgba(var(--tw-shadow-color), 0.1);
  }
</style>
